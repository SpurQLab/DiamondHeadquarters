@Celestia_Bloom_Women_Ring
Feature: Celestia Bloom Women Ring
  As a shopper
...
@smoke1
  Scenario Outline: Search for Celestia Bloom Women Ring with size 5 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
    And I select size "5"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 6 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
    And I select size "6"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 7 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
    And I select size "7"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 8 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
    And I select size "8"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 9 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
    And I select size "9"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 10 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 11 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 12 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 13 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 14 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 15 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 16 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 17 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 18 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 19 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
  ...
  Scenario Outline: Search for Celestia Bloom Women Ring with size 20 and validate variant weights
    Given I open Ringsandi site "https://ringsandi.com/"
    When I search for "Celestia Bloom Women Ring"
    And I select product "Celestia Bloom Women Ring"
